...
def parse_args():
    ...
    parser.add_argument('--data_dir', type=str, default='samples/1029/', help='data dir containing facehair and garment images')
...
if __name__ == '__main__':
    ...
    #prepare image
    face_img = cv2.imread(args.data_dir + 'facehair.png', cv2.IMREAD_UNCHANGED)
    garment_img = cv2.imread(args.data_dir + 'garment_top.png', cv2.IMREAD_UNCHANGED)
